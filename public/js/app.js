...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    console.log(parsedItems); // return parsedItems.forEach((menuItem) => {
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format("DD-MM-YYYY , hh:mm A");
...
var scrollButton = document.querySelector("#scrollBtn");
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51JAEsfSD2RJ4GbdiOjgv5vb33VggGAgo4hdgo6fjozpH68CwC65nwpHG5Ww7KcfAWEyFLqCd2v5UK7AwN6cS6DEQ00NFo8GGXj");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkstreetfood"] = self["webpackChunkstreetfood"] || [];
